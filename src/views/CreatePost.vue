<template>
  <div class = "create-post">
    <BlogCoverPhotoPreview v-show = "this.$store.state.blogPhotoPreview" />
...
import BlogCoverPhotoPreview from "../components/BlogCoverPhotoPreview";
  ...
  methods:{
    ...
    uploadBlog(){
      if(this.blogTitle.length !== 0 && this.blogHTML.length !== 0){
        ...
        this.error = true;
        this.errorMsg = "Please make sure you have uploaded a blog photo!";
        setTimeout(() => {
          this.error = false;
        },5000);
        return;
